...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        # Set number of nodes in input, hidden and output layers, and learning rate
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # technically, should be output_error_term instaed of error
        hidden_error =  error.dot(self.weights_hidden_to_output.T)
        #print("Hiddent error: ", hidden_error)

        # Backpropagated error terms - Replace these values with your calculations.
        # Error term is the layer's error x layer's activation function derivative
        # As output layer's activation function is f(x) = x, derivitve is 1 here 
        output_error_term = error 
        #print("Output error term: ", output_error_term)
        
        # Sigmoid function derivative is f(x)(1-f(x)), f(x) the node output,
        # at the hidden node the output is the hidden node output
